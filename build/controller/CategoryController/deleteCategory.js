...
const deleteCategory = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const category = yield CategoryModel_1.CategoryModel.findOne({ _id, adminUserId });
        if (!category) {
            return (0, responseFun_1.sendErrorResponse)(res, 404, "Category not found or unauthorized");
        }
        yield CategoryModel_1.CategoryModel.findByIdAndDelete(_id);
        return (0, responseFun_1.sendSuccessWithoutResponse)(res, "Category deleted successfully");
    }
    catch (error) {
