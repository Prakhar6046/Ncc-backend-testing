...
const GetSingleOrderService = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const singleOrder = yield NccBooking_1.NccBookingModel.findOne({ _id: orderId });
        if (!singleOrder) {
            return (0, responseFun_1.sendErrorResponse)(res, 404, `No order found with ID: ${orderId}. Please check and try again.`);
        }
...
exports.default = GetSingleOrderService;
