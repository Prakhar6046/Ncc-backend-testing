...
const SelectDriverModel = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
        ...
        const CarModel = yield CarModel_1.CarModels.findById(carModel);
        ...
        yield CarDriver_1.CarDriversModel.findByIdAndUpdate(DriverId, { $set: { carModel: carModel, carType: (_a = CarModel === null || CarModel === void 0 ? void 0 : CarModel.carType) !== null && _a !== void 0 ? _a : null } }, { new: true });
        ...
        if (DriverInfo.carModel && DriverInfo.carModel.toString() !== carModel) {
            yield CarModel_1.CarModels.updateOne({ _id: DriverInfo.carModel }, { $set: { driverAssign: false, driverId: null } });
        }
...
exports.default = SelectDriverModel;
