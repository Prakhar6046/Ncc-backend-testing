...
const SendDriverAcceptanceEmailToHotel = (hotelEmail, driverInfo, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let mailOptions = {
      ...
      `,
        ...
        emailTransporter_1.default.sendMail(mailOptions, function (error, info) {
            if (error) {
                console.log(error);
                res.status(500).send({
                    status: false,
...
exports.default = SendDriverAcceptanceEmailToHotel;
